...
public class Carro {
	...
	public boolean detalleNoSuperaStock(Detalle detalle, Producto producto) {
		int cantDet = detalle.getCantidad();
		int cantProd = producto.getStock();
		return cantDet < cantProd ? true : false;
	}
}
