...
public class AppTest {
	...
	public void cantidadDelProductoIndicada(){
		...
		Detalle detalle = new Detalle(producto, cantidadEsperada,1);
		
		//Act
		int cantidadObtenida = detalle.getCantidad();
	...
	public void cantidadDetalleNoMayorQueStock() {
		...
		//Act
		boolean superado = carrito.detalleNoSuperaStock(detalle,producto);
